...
const DiscordUi = () => {
  return (
    <MaxWidthWrapper className="flex items-center h-full ">
      <div className="flex flex-1 bg-[#272831] min-h-[700px] max-w-[1200px] w-full h-full rounded-sm">
        <div className="  bg-gray-900 p-2 rounded-l-sm  min-h-[700px] h-full flex flex-col ">
          {/* server */}
        ...
        <div className="hidden md:flex flex-col  w-60 bg-[#2f3136] h-full  min-h-[700px] ">
          ...
          <div className=" flex  gap-2 text-[#dcddde] w-full p-1 bg-gray-800 text-xs mt-auto ">
        ...
        <div className="w-full bg-[#36393f] flex flex-col rounded-r-md">
          <div className="w-full p-2 flex justify-between items-center text-[#dcddde]">
            <div className="flex justify-center items-center gap-4 ">
              <Image
                ...
                quality={100}
              />
              <div className=" text-lg font-semibold select-none hover:text-gray-500">
                Zeno
              </div>
            </div>
            {/* ProfileIcons */}
            ...
            <div className="flex gap-4 p-2 ">
              <Phone className="hover:text-gray-600" />
              <Video className="hover:text-gray-600" />
              <Pin className="hover:text-gray-600" />
              <UserCircle className="hover:text-gray-600" />
              <Search className="hover:text-gray-600" />
              <Home className="hover:text-gray-600" />
            </div>
          </div>
          ...
          {/* Input button */}
          <div className="p-2 text-[#dcddde]  mt-auto mb-1 border">
