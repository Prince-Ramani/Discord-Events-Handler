...
import { z } from "zod";
import { CATEGORY_NAME_VALIDATOR } from "./validators/category_name_validator";
          ...
          <div className="space-y-5">
            <div>
              ...
              <Input
                ...
                id="name"
                {...register("name")}
                placeholder="e.g. Purchased Premium"
                className="w-full"
              />
              {errors.name ? (
                ...
                {EMOJI_OPTIONS.map(({ emoji }) => (
                  <button
                    ...
                    className={cn(
                      ...
                      selectedEmoji === emoji
                        ? "bg-purple-100 ring-2 ring-purple-700 scale-110"
